    ...
    <main>
        ...
        <section class="px-4 py-32"
            ...
            <div class="flex justify-around">
                <div class="max-w-xl">
                    ...
                    <p class="mt-4 text-lg leading-relaxed">Feel free to reach out to us for home delivery and any
                        queries you may have. We're here to assist you with the best products delivered right to your
                        doorstep.</p>
        ...
        <section>
            <div class="flex justify-center items-center">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3720.072522765736!2d81.3068905!3d21.189277800000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a293d3d1eca040b%3A0x524fd3bf1977f511!2sKachhi%20ghani%20Telwale!5e0!3m2!1sen!2sin!4v1729084643845!5m2!1sen!2sin"
        ...
        <section>
            <div class="mt-6 w-full mx-auto bg-yellow-500 rounded-lg">
                <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                    <div>
                        ...
                        <p class="text-sm text-white mt-4 leading-relaxed">Need premium quality cold-pressed oils for
                            your home or business? Reach out to us, we're excited to assist you with the finest products
                        ...
                        <ul class="mt-12 space-y-8">
                            ...
                            <li class="flex items-center">
                                ...
                                <a href="tel:9131923249" class="text-white text-sm ml-4">
                                    +91 9131923249
                                </a>
                                <a href="tel:8223970011" class="text-white text-sm ml-4">
                                    +91 8223970011
                                </a>
                            </li>
                            <li class="flex items-center">
                        ...
                        <ul class="flex mt-12 space-x-4">
                            <li
                                class="bg-orange-400 hover:bg-orange-400 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg">
                        <p class="text-sm font-semibold text-gray-800">I'm interested </p>

                        <form class="mt-8 space-y-4">
                            <input type='text' placeholder='Name'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-orabg-orange-400" />
                            <input type='email' placeholder='Email'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-orabg-orange-400" />
                            <input type='tel' placeholder='Mobile'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-orabg-orange-400" />
                            <textarea placeholder='Message' rows="6"
                                class="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-orabg-orange-400"></textarea>
                            <button type='button'
                                class="text-white bg-orange-400 hover:bg-orange-400 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='#fff'
