    ...
    <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-4     overflow-hidden sm:px-6 lg:px-8">
        <nav>
            <div class="flex justify-center">
                <img src="./assets/img/logo.png" alt="Workflow logo" class="h-52">
            </div>

        </nav>
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
            <div class="px-5 py-2">
                <a href="about.php" class="text-base leading-6 text-black hover:text-gray-900">
                    About
                </a>
            </div>

            <div class="px-5 py-2">
                <a href="products.php" class="text-base leading-6 text-black hover:text-gray-900">
                    Product
                </a>
            </div>

            <div class="px-5 py-2">
                <a href="contact.php" class="text-base leading-6 text-black hover:text-gray-900">
                    Contact Us
                </a>
            </div>
        ...
        <p class="mt-8 text-base leading-6 text-center text-black">
            &copy; <?php echo date('Y'); ?> Telwale.com . All rights reserved.
        </p>
    </div>
</section>